...
export const FLAG = "Drag the piece of flag on the right side. Put them all together underneath in the right way to advance to another level. On mobile, just shake and reset. Please allow motion sensor in web settings."
